...
(function() {
    ...
    db.query('CREATE TABLE IF NOT EXISTS public.game (data json NOT NULL, id bigserial NOT NULL, last_updated timestamp without time zone NOT NULL, created timestamp without time zone NOT NULL, PRIMARY KEY (id))');
